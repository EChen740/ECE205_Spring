#include <iostream>
#include <stack> //include this so we can use stakc 
#include <string> //include this so we can use string
#include <cctype> //allows u to see if a integer isdigit or not, function found in cpp library. 

using namespace std; //so we don't have to keep on stype std:: etc.....
...
int main() {
    ...
    cout << "Calculated results using Shunting Yard algorithm: " << result << endl;
